    ...
    <section id="skills" className='w-full bg-custom-multi-gradient py-25 md:py-40 clip-path-custom'>
        <div className='w-full max-w-[900px] px-6 mx-auto text-center space-y-12'>
         ...
         <div className='text-center space-y-3'>
           ...
           <div className="h-1 max-w-28 bg-purple-500 mx-auto"></div>
                 ...
                 <Tilt
                                 ...
                                 <div className="grid grid-cols-2 lg:grid-cols-3 gap-1">
                   {
                     category.skills.map((skill)=>{
                        return (<div key={skill.name} className="p-2 flex justify-center gap-1 xs:gap-1 items-center border-2 border-gray-700 rounded-4xl bg-transparent ">
